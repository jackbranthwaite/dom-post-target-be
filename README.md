...
1. Find and replace `tar` with a short ~3 character project ID to represent the application name. (e.g "My awesome app" -> "maa", "formfunfunction" -> "fff").
...
5. Generate application key
    ```bash
    docker exec tar-php php artisan key:generate
    ```
